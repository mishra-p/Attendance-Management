    ...
    <?php
        switch ($_REQUEST['reportid']) 
        {
          case '1':
            ...
            echo "</div>";
            echo "<div class='row'>";
            echo "<form class='form ' action='report_calc_admin.php' method='POST' target='Iframe2'>";
            ...
            echo "<select class='form-control' autocomplete='off' name='cid'>";
            echo "<option selected disabled>Select Course</option>";
            $sql="SELECT course.cid,course.cname,course.branch,course.semester,alloted_subject.tid from alloted_subject,course where alloted_subject.cid=course.cid ";
            $result=$conn->query($sql);
            while($row=mysqli_fetch_assoc($result))
              {
                echo "<option value='".$row['cid'].",".$row['tid']."'>";
          ...
          case '4':
            ...
            echo "<input class='form-control' id='datepicker' name='date' type='text' value='mm/dd/yyyy' onfocus='this.value = '';' onblur='if (this.value == '') {this.value = 'yyyy/mm/dd';}' required='''>";
            echo "</div>";
            echo "<div class='form-group'>";
            echo "<label>Present :</label>";
            echo "<input type='radio' name='present' value='P'>";
            echo "</div>";
             echo "<div class='form-group'>";
             echo "<label>Absent :</label>";
            echo "<input type='radio' name='present' value='A'>";
            echo "</div>";
